...
const STATUS_CONFIGS: Record<string, StatusConfig> = {
  live: {
    icon: '🟢',
    label: 'Up-to-date data',
    description: 'Showing recent data from government and public sources.',
    color: '#22c55e',
    bgColor: '#f0fdf4',
    borderColor: '#bbf7d0',
  },
  'historical-fallback': {
    icon: '📊',
    label: 'Sample data',
    description: 'Live data wasn’t available; showing sample data so you can still explore.',
    color: '#f59e0b',
    bgColor: '#fffbeb',
    borderColor: '#fed7aa',
  },
  ...
  error: {
    icon: '🔴',
    label: 'Couldn’t load',
    description: 'We couldn’t load this data. You can try again or use sample data.',
    color: '#ef4444',
    bgColor: '#fef2f2',
    borderColor: '#fecaca',
  },
